import { Marker, AnchorLocation } from 'utility/eposLeaflet/eposLeaflet';
 ...
 export class RawIcon extends Marker {
   private raw = '';
    ...
    * @param {string} raw - The `raw` parameter is a string that represents the base64 image that you
    * want to configure.
    ...
    */
   public configure(raw: string, maxHeightPx?: number, maxWidthPx?: number): this {
     this.raw = raw;
