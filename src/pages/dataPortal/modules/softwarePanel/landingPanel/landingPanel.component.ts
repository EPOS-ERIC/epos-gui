...
export class LandingPanelComponent implements OnInit, AfterContentInit {
  ...
  ngOnInit(): void {
    ...
    // FIX: Use the correct local storage variable for the software context
    const activeDomainCode = this.localStoragePersister.getValue(LocalStorageVariables.LS_CONFIGURABLES, LocalStorageVariables.LS_DOMAIN_OPEN + CONTEXT_SOFTWARE) as string | null ?? false;
